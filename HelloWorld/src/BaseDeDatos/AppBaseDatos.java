...
public class AppBaseDatos {
  ...
  public void borrarAlumnos(String id) {
    try {
      // SQL para borrar registros de la tabla alumno basándose en la matricula
      String sql = "DELETE FROM alumno WHERE asdf = ?";

      // Ejemplo de matrícula de un alumno a borrar (deberías reemplazarlo con un
      // valor real)
      UUID idAlumno = UUID.fromString(id);

      preparedStatement = connection.prepareStatement(sql);
      preparedStatement.setObject(1, idAlumno);
  ...
  public static void main(String[] args) {
    ...
    try {
      app.connectDatabase();
      // app.insertarAlumnos();
      // app.darDeBajaAlumno("ebb69404-b0a4-48ad-b4f2-16de50e97c3a");
      app.borrarAlumnos("ebb69404-b0a4-48ad-b4f2-16de50e97c3a");
      // app.regresarAlumnos();
      // app.-("A2013001");
